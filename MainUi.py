...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QtCore.QSize(880, 640))
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.gridLayout = QtWidgets.QGridLayout(self.centralwidget)
        self.gridLayout.setContentsMargins(10, 5, 20, 5)
        ...
        self.gridLayout.addWidget(self.label_6, 6, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.voltage, 12, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_15, 16, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.label_3, 11, 5, 1, 1)
        self.com_port_cb = QtWidgets.QComboBox(self.centralwidget)
        self.com_port_cb.setMinimumSize(QtCore.QSize(90, 40))
        self.com_port_cb.setMaximumSize(QtCore.QSize(90, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        self.com_port_cb.setFont(font)
        self.com_port_cb.setObjectName("com_port_cb")
        self.gridLayout.addWidget(self.com_port_cb, 2, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_10, 10, 0, 1, 4)
        ...
        self.direct_wind.setStyleSheet("")
        ...
        self.gridLayout.addWidget(self.direct_wind, 4, 4, 1, 1)
        ...
        self.temp_ds18b20.setStyleSheet("")
        ...
        self.gridLayout.addWidget(self.temp_ds18b20, 11, 4, 1, 1)
        ...
        self.speed_wind_avarage.setStyleSheet("")
        ...
        self.gridLayout.addWidget(self.speed_wind_avarage, 13, 7, 1, 1)
        ...
        self.direct_wind_acp.setStyleSheet("")
        ...
        self.gridLayout.addWidget(self.direct_wind_acp, 11, 7, 1, 1)
        ...
        self.speed_wind_metr.setStyleSheet("")
        ...
        self.gridLayout.addWidget(self.speed_wind_metr, 7, 4, 1, 1)
        ...
        self.diff_speed_wind.setStyleSheet("background-color: rgb(161, 255, 255);")
        self.diff_speed_wind.setAlignment(QtCore.Qt.AlignCenter)
        self.diff_speed_wind.setObjectName("diff_speed_wind")
        self.gridLayout.addWidget(self.diff_speed_wind, 13, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_5, 12, 5, 1, 1)
        ...
        self.adr_control.setStyleSheet("")
        ...
        self.gridLayout.addWidget(self.adr_control, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.humidity, 10, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_13, 14, 0, 1, 4)
        ...
        self.direct_wind_avarage.setStyleSheet("")
        ...
        self.gridLayout.addWidget(self.direct_wind_avarage, 12, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_7, 14, 5, 1, 1)
        ...
        self.diff_voltage.setStyleSheet("background-color: rgb(161, 255, 255);")
        self.diff_voltage.setAlignment(QtCore.Qt.AlignCenter)
        self.diff_voltage.setObjectName("diff_voltage")
        self.gridLayout.addWidget(self.diff_voltage, 16, 4, 1, 1)
        ...
        self.diff_humidity.setStyleSheet("background-color: rgb(161, 255, 255);")
        self.diff_humidity.setAlignment(QtCore.Qt.AlignCenter)
        self.diff_humidity.setObjectName("diff_humidity")
        self.gridLayout.addWidget(self.diff_humidity, 14, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_14, 16, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.speed_wind, 6, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_9, 13, 5, 1, 1)
        ...
        self.humidity_counter.setStyleSheet("")
        ...
        self.gridLayout.addWidget(self.humidity_counter, 14, 7, 1, 1)
        self.adr_control_start = QtWidgets.QLineEdit(self.centralwidget)
        self.adr_control_start.setMinimumSize(QtCore.QSize(60, 40))
        self.adr_control_start.setMaximumSize(QtCore.QSize(60, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        self.adr_control_start.setFont(font)
        self.adr_control_start.setStyleSheet("background-color: rgb(161, 255, 255);")
        ...
        self.gridLayout.addWidget(self.adr_control_start, 2, 5, 1, 1)
        ...
        self.find_addr_btn.setMinimumSize(QtCore.QSize(180, 40))
        self.find_addr_btn.setMaximumSize(QtCore.QSize(180, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        self.find_addr_btn.setFont(font)
        self.find_addr_btn.setObjectName("find_addr_btn")
        self.gridLayout.addWidget(self.find_addr_btn, 6, 5, 1, 1)
        ...
        self.calc_humidity.setStyleSheet("")
        ...
        self.gridLayout.addWidget(self.calc_humidity, 16, 7, 1, 1)
        ...
        self.write_adr_btn.setMinimumSize(QtCore.QSize(90, 40))
        self.write_adr_btn.setMaximumSize(QtCore.QSize(90, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        self.write_adr_btn.setFont(font)
        self.write_adr_btn.setObjectName("write_adr_btn")
        self.gridLayout.addWidget(self.write_adr_btn, 4, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.connect_btn, 4, 7, 1, 1)
        self.read_base_btn = QtWidgets.QPushButton(self.centralwidget)
        self.read_base_btn.setMinimumSize(QtCore.QSize(150, 40))
        self.read_base_btn.setMaximumSize(QtCore.QSize(150, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        self.read_base_btn.setFont(font)
        self.read_base_btn.setObjectName("read_base_btn")
        self.gridLayout.addWidget(self.read_base_btn, 7, 7, 1, 1)
...
"датчика влажности"))
        ...
        self.label_4.setText(_translate("MainWindow", "Направление ветра в градусах"))
